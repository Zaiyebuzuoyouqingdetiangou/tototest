import { updateLatestVisualSignature } from './storage.js?rmv=1.4.30.14';
import { consumeInjectedFeedbackForSuccessfulRabbitMirror } from './feedbackCat.js?rmv=1.4.30.14';
import { getSettings } from './settings.js?rmv=1.4.30.14';
import {
    captureRabbitMirrorGenerationSnapshots,
    getRabbitMirrorGenerationSnapshot,
    inspectRabbitMirrorGenerationSource,
} from './generationGuard.js?rmv=1.4.30.14';
