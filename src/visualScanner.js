import { getCurrentChatKey, updateLatestVisualSignature } from './storage.js?rmv=1.5.30-layout1';
import { consumeInjectedFeedbackForSuccessfulRabbitMirror } from './feedbackCat.js?rmv=1.5.30-layout1';
import { getSettings } from './settings.js?rmv=1.5.30-layout1';
import { applyRabbitMirrorBannedWordsToDom } from './bannedWords.js?rmv=1.5.30-layout1';
import {
...
} from './generationGuard.js?rmv=1.5.30-layout1';
import {
...
} from './multifaceProof.js?rmv=1.5.30-layout1';
...
import { createMultifaceFailureSlot, MULTIFACE_FAILURE_ATTR, parseMultifaceOutput } from './multifaceProtocol.js?rmv=1.5.30-layout1';
import { saveFollowPartialResult } from './followPartialResults.js?rmv=1.5.30-layout1';
...
function loadFollowBatchSanitizer() {
    if (!followBatchSanitizerModulePromise) {
        followBatchSanitizerModulePromise = import('./outputSanitizer.js?rmv=1.5.30-layout1').catch(error => {
