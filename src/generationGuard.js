...
import { recordRabbitMirrorRecipe } from './blacklist.js?rmv=1.5.28-guide1';
import { parseMultifaceOutput, recoverableMultifaceFrames, createMultifaceFailureSlot, multifaceRecoveryWithinRawBudgets } from './multifaceProtocol.js?rmv=1.5.28-guide1';
