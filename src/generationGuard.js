...
import { recordRabbitMirrorRecipe } from './blacklist.js?rmv=1.5.41-memory1';
import { parseMultifaceOutput, recoverableMultifaceFrames, createMultifaceFailureSlot, multifaceRecoveryWithinRawBudgets } from './multifaceProtocol.js?rmv=1.5.41-memory1';
