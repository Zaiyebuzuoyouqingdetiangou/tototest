...
import { getCurrentChatKey } from './storage.js?rmv=1.3.16';
import {
    FEEDBACK_CAT_TYPES,
...
} from './feedbackCat.js?rmv=1.3.16';
import { scanRabbitMirrorHtml } from './visualScanner.js?rmv=1.3.16';
import { getRabbitMirrorGenerationSnapshot } from './generationGuard.js?rmv=1.3.16';
...
const INTERACTION_DIAGNOSTIC_VERSION = '1.3.16-FULL-CHAIN';
...
function positionFeedbackCatPanel(panel, button, preferredWidth = 300) {
    ...
    // 1.3.16: on phones the menu is taller than the visual viewport. Use the
