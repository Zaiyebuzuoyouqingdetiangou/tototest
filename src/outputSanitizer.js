...
import { getCurrentChatKey } from './storage.js?rmv=1.3.12';
import {
    FEEDBACK_CAT_TYPES,
...
import { getRabbitMirrorGenerationSnapshot } from './generationGuard.js?rmv=1.3.12';
...
function positionFeedbackCatPanel(panel, button, preferredWidth = 300) {
    ...
    // 1.3.12: on phones the menu is taller than the visual viewport. Use the
