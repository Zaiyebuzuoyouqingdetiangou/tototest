...
import { isRabbitMirrorManagedChatSurface, getRabbitMirrorMountedMessages, getRabbitMirrorExternalPlacementParent, subscribeRabbitMirrorChatSurface } from './hostCompatibility.js?rmv=1.5.39-tttouch1';
import { recordTtSurface, ttSurfaceNow } from './ttSurfaceDiagnostics.js?rmv=1.5.39-tttouch1';
import { WORLD_INFO_BOOK_NAME_MAX_CHARS, getSettings, normalizeIndependentContextExcludedTags, updateSettings } from './settings.js?rmv=1.5.39-tttouch1';
import { assertRabbitMirrorIndependentResponseBytes, assertRabbitMirrorIndependentResponseText, authorizeRabbitMirrorIndependentServiceRequest, fetchRabbitMirrorIndependentCompletion } from './independentSecurityGuard.js?rmv=1.5.39-tttouch1';
import { buildRabbitMirrorPromptDetails, planRabbitMirrorPromptDetails, renderRabbitMirrorPromptPlan } from './promptBuilder.js?rmv=1.5.39-tttouch1';
import { getExternalPoolHydrationStatus, getSelectedExternalEntries, hydrateExternalPoolMetadata } from './externalWorldBook/store.js?rmv=1.5.39-tttouch1';
import { describeExternalWorldBookPreflightFailure, describeBatchPlanFailure } from './externalWorldBook/errors.js?rmv=1.5.39-tttouch1';
...
import { rememberRabbitMirrorFilteredDom, cloneRabbitMirrorFilteredNode } from './bannedWords.js?rmv=1.5.39-tttouch1';
import { createRabbitMirrorTextReplacementReceipt, matchesRabbitMirrorTextReplacementReceipt } from './replacementReceipt.js?rmv=1.5.39-tttouch1';
import { parseMultifaceOutput, recoverableMultifaceFrames, createMultifaceFailureSlot, MULTIFACE_FAILURE_ATTR, normalizedSummaryText } from './multifaceProtocol.js?rmv=1.5.39-tttouch1';
...
import { FOLLOW_MULTIFACE_COMMITTED_EVENT, FOLLOW_MULTIFACE_REJECTED_EVENT, getRabbitMirrorFollowBatchFailure, scanRabbitMirrorHtml } from './visualScanner.js?rmv=1.5.39-tttouch1';
import { getCurrentChatKey, updateLatestVisualSignature, parseVisualFamilySkeleton, describeVisualFamilyDimensions, markPendingBatchAttempt, commitPendingComboBatch, releasePendingComboBatch } from './storage.js?rmv=1.5.39-tttouch1';
import { buildFeedbackCatFinalCheck, buildFeedbackCatPrompt, consumeInjectedFeedbackForSuccessfulIndependentRabbitMirror, getActiveFeedbackForCurrentChat, markFeedbackCatInjected } from './feedbackCat.js?rmv=1.5.39-tttouch1';
import { getRabbitMirrorRecipe, recordRabbitMirrorRecipe } from './blacklist.js?rmv=1.5.39-tttouch1';
import { readFollowPartialResult, followPartialResultFaceOwnerKey } from './followPartialResults.js?rmv=1.5.39-tttouch1';
import { recordRabbitMirrorIndependentPrompt } from './tokenMeter.js?rmv=1.5.39-tttouch1';
import { PRESENTATION_FORMATS } from '../data/structured/presentationIndex.js?rmv=1.5.39-tttouch1';
import { rememberIndependentTransportDiagnostic } from './transportDiagnostics.js?rmv=1.5.39-tttouch1';
...
async function loadIndependentAppearanceReference(owner){
 ...
 assertIndependentPromptOwner(owner);
 try{
  try{module=await import('./appearanceReference.js?rmv=1.5.39-tttouch1');}
  catch{
...
function resayIndependentMirror(root,owner={}){
 if(getSettings().generationSource==='follow'){
  void import('./followFaceRetry.js?rmv=1.5.39-tttouch1').then(({retryFollowFace})=>retryFollowFace(root,owner,{
...
async function probeIndependentEarlyBody(packet,sequence){
 ...
 if(!earlyBodyParserPromise) earlyBodyParserPromise=import('./earlyBodyTags.js?rmv=1.5.39-tttouch1')
