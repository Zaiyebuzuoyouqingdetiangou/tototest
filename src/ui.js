import { getSettings, updateSettings, resetSettings } from './settings.js?rmv=1.1.0b14h4t';
import { clearLastCombo } from './storage.js?rmv=1.1.0b14h4t';
import { clearRabbitMirrorPrompt } from './injector.js?rmv=1.1.0b14h4t';
import { clearFeedbackCatExtensionPrompt, getActiveFeedbackForCurrentChat, syncFeedbackCatExtensionPrompt } from './feedbackCat.js?rmv=1.1.0b14h4t';
import { configureMaintenanceAutoSafeMode, refreshFeedbackCats, refreshMaintenanceRabbits } from './outputSanitizer.js?rmv=1.1.0b14h4t';
import { scanMemoryPlugins, testMemoryProvider } from './memoryScanner.js?rmv=1.1.0b14h4t';
import { getLastRabbitMirrorTokenRecord, TOKEN_METER_EVENT } from './tokenMeter.js?rmv=1.1.0b14h4t';
import { fetchIndependentModels, refreshRabbitMirrorGenerationMode, testIndependentConnection } from './independentApi.js?rmv=1.1.0b14h4t';

const SETTINGS_UI_VERSION = '1.1.0-beta.14.4-test';
...
<div id="rabbit_mirror_theater_settings" class="rabbit-mirror-settings" data-rabbit-mirror-ui-version="${SETTINGS_UI_VERSION}" data-rabbit-mirror-runtime-version="${RUNTIME_VERSION}">
  <div class="inline-drawer">
    <div class="inline-drawer-toggle inline-drawer-header">
      <b>兔子镜小剧场 / Rabbit Mirror Theater <span style="font-size:11px;opacity:.72;">[TEST・生成方式切换・维修兔 v1.70-test]</span></b><span class="rabbit-mirror-toto-watermark">Toto Beta v1.1</span>
      ...
      <details class="rabbit-mirror-section" open>
        ...
        <div class="rabbit-mirror-section-content">
          ...
          <div id="rh_independent_api_fields" style="margin-left:26px;display:grid;gap:7px;">
            <input id="rh_independent_base" class="text_pole" type="url" placeholder="OpenAI 兼容 API 地址，例如 https://example.com/v1">
