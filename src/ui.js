import { getSettings, updateSettings, resetSettings } from './settings.js?rmv=1.2.40';
import { clearLastCombo } from './storage.js?rmv=1.2.40';
import { clearRabbitMirrorPrompt } from './injector.js?rmv=1.2.40';
import { clearFeedbackCatExtensionPrompt, getActiveFeedbackForCurrentChat, syncFeedbackCatExtensionPrompt } from './feedbackCat.js?rmv=1.2.40';
import { configureMaintenanceAutoSafeMode, refreshFeedbackCats, refreshMaintenanceRabbits } from './outputSanitizer.js?rmv=1.2.40';
import { scanMemoryPlugins, testMemoryProvider } from './memoryScanner.js?rmv=1.2.40';
import { getLastRabbitMirrorTokenRecord, TOKEN_METER_EVENT } from './tokenMeter.js?rmv=1.2.40';
import { API_REQUEST_DIAGNOSTIC_EVENT, fetchIndependentModels, getLastIndependentApiRequestDiagnostic, refreshRabbitMirrorGenerationMode, testIndependentConnection } from './independentApi.js?rmv=1.2.40';

const SETTINGS_UI_VERSION = '1.2.40';
