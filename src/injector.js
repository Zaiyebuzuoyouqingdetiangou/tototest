...
import { MODULE_NAME, getSettings } from './settings.js?rmv=1.2.64';
...
import { recordRabbitMirrorInjection, recordRabbitMirrorNoInjection } from './tokenMeter.js?rmv=1.2.64';
import { beginRabbitMirrorGenerationAttempt } from './generationGuard.js?rmv=1.2.64';
