import { detectWorldBookCapabilities, getHostRequestHeaders, requireHostHeaders } from './capabilities.js?rmv=1.5.35-stability1';
import { EXTERNAL_WORLD_BOOK_ERROR_CODES, ExternalWorldBookError } from './errors.js?rmv=1.5.35-stability1';
import { normalizeHostWorldBook } from './normalize.js?rmv=1.5.35-stability1';
