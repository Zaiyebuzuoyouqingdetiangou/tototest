import { getSettings, updateSettings } from './settings.js?rmv=1.5-varietyfix1';
import { getCurrentChatKey, resetFormatEligibleMisses } from './storage.js?rmv=1.5-varietyfix1';
