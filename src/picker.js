import { THEMATIC_CATEGORIES } from '../data/structured/thematicIndex.js?rmv=1.3.9';
import { PRESENTATION_FORMATS } from '../data/structured/presentationIndex.js?rmv=1.3.9';
import {
    getCurrentChatKey,
