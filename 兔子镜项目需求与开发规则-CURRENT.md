...
更新：2026-09-07。当前发布包：1.5.28，基于保留的 1.5.27；manifest/runtime 为 `1.5.28`，主 cache cohort 为 `1.5.28-guide1`。本文是本包唯一 CURRENT；以下旧版本条目属于历史约束。跨设备保存尚未实现，手机热与长延迟仍需实机验收。
