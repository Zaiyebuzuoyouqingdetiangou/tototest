...
更新：2026-09-06。当前测试候选：1.5.22 BatchFix1；manifest/runtime 为 `1.5.22`，主 cache cohort 为 `1.5.22-batchfix1`。本文是本包唯一 CURRENT；旧 README／CHANGELOG 历史段落和 `docs/multiface-phase2-design.md` 的早期方案不代替实际源码。此为测试候选，不是已完成真实宿主/模型/iPhone 验收的正式版。
