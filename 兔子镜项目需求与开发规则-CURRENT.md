...
更新：2026-09-08。当前安装包：1.5.31，基于保留的 1.5.30；manifest/runtime 为 `1.5.31`，主 cache cohort 为 `1.5.31-compat1`。本文是本包唯一 CURRENT；以下旧版本条目属于历史约束。双向跨设备保存尚未补齐，手机热与长延迟仍需实机验收。
