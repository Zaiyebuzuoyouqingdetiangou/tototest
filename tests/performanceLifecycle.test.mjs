...
assert.match(index, /\.\/src\/ui\.js\?rmv=1\.4\.9-startupdiag1/, 'ui.js must load from the multiface-step1 cache cohort');
...
assert.equal(manifest.js, 'index.js?rmv=1.4.9-test-multiface-step1-startupdiag1');
assert.equal(manifest.version, '1.4.9-test-multiface-step1-startupdiag1');
