...
assert.match(independent, /const STARTUP_SYNC_CHUNK_MESSAGES=4/);
...
assert.match(index, /\.\/src\/ui\.js\?rmv=1\.4\.7-ms1/, 'ui.js must load from the multiface-step1 cache cohort');
...
assert.equal(manifest.js, 'index.js?rmv=1.4.7-test-multiface-step1');
assert.equal(manifest.version, '1.4.7-test-multiface-step1');
