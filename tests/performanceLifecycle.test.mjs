...
assert.match(index, /\.\/src\/ui\.js\?rmv=1\.5\.19-usability1/, '1.5 UI parent must use its dedicated cache key');
...
assert.equal(manifest.js, 'index.js?rmv=1.5.19-usability1');
