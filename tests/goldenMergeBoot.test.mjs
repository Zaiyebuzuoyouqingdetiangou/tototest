...
assert.match(index, /GOLDEN_MERGE_VERSION\s*=\s*'1\.5\.5'/);
...
assert.match(index, /import\('\.\/src\/ui\.js\?rmv=1\.5-varietyfix1'\)/);
assert.match(index, /import\('\.\/src\/externalDiagnostics\.js\?rmv=1\.5-varietyfix1'\)/);
