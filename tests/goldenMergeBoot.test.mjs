...
assert.match(index, /GOLDEN_MERGE_VERSION\s*=\s*'1\.5\.3'/);
...
assert.match(index, /import\('\.\/src\/ui\.js\?rmv=1\.5-qualityfix4'\)/);
assert.match(index, /import\('\.\/src\/externalDiagnostics\.js\?rmv=1\.5-qualityfix4'\)/);
