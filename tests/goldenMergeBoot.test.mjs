...
assert.match(index, /GOLDEN_MERGE_VERSION\s*=\s*'1\.4\.9-externaldiag1-securityfix6-subapitag2-advancedui1-stability1-repairemoji1-cleanui1-widthfix1-apifix2-modelselectfix1-streamfix1-variety1'/);
...
assert.match(index, /import\('\.\/src\/ui\.js\?rmv=1\.4\.9-subapitag2-advancedui1-stability1-repairemoji1-cleanui1-widthfix1-apifix2-modelselectfix1-streamfix1-variety1'\)/);
assert.match(index, /import\('\.\/src\/externalDiagnostics\.js\?rmv=1\.4\.9-subapitag2-advancedui1-stability1-repairemoji1-cleanui1-widthfix1-apifix2-modelselectfix1-streamfix1-variety1'\)/);
