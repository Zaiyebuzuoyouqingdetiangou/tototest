...
assert.match(index, /GOLDEN_MERGE_VERSION\s*=\s*'1\.5\.20'/);
...
assert.match(index, /import\('\.\/src\/ui\.js\?rmv=1\.5\.20-runtimefix1'\)/);
assert.match(index, /import\('\.\/src\/externalDiagnostics\.js\?rmv=1\.5\.20-runtimefix1'\)/);
