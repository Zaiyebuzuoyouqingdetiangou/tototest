...
assert.match(indexSource, /\.\/src\/ui\.js\?rmv=1\.5\.19-usability1/);
assert.match(uiSource, /\.\/injector\.js\?rmv=1\.5\.19-usability1/);
assert.match(uiSource, /\.\/independentApi\.js\?rmv=1\.5\.19-usability1/);
