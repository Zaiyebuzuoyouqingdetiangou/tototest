...
assert.match(indexSource, /\.\/src\/ui\.js\?rmv=1\.5\.6-abc1/);
assert.match(uiSource, /\.\/injector\.js\?rmv=1\.5\.6-abc1/);
assert.match(uiSource, /\.\/independentApi\.js\?rmv=1\.5\.6-abc1/);
