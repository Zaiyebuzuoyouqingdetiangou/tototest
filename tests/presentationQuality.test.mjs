...
assert.match(indexSource, /\.\/src\/ui\.js\?rmv=1\.4\.9-subapitag2/);
assert.match(uiSource, /\.\/injector\.js\?rmv=1\.4\.9-subapitag2/);
assert.match(uiSource, /\.\/independentApi\.js\?rmv=1\.4\.9-subapitag2/);
