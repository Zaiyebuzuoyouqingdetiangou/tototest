...
assert.match(indexSource, /\.\/src\/ui\.js\?rmv=1\.4\.9-lightboot1/);
assert.match(uiSource, /\.\/injector\.js\?rmv=1\.4\.9-lightboot1/);
assert.match(uiSource, /\.\/independentApi\.js\?rmv=1\.4\.9-lightboot1/);
