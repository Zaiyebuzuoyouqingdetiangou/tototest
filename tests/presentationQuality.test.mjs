...
assert.match(indexSource, /\.\/src\/ui\.js\?rmv=1\.5\.20-runtimefix1/);
assert.match(uiSource, /\.\/injector\.js\?rmv=1\.5\.20-runtimefix1/);
assert.match(uiSource, /\.\/independentApi\.js\?rmv=1\.5\.20-runtimefix1/);
