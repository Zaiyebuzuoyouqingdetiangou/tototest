...
assert.match(indexSource, /\.\/src\/ui\.js\?rmv=1\.5\.18-audit1c2/);
assert.match(uiSource, /\.\/injector\.js\?rmv=1\.5\.18-audit1c2/);
assert.match(uiSource, /\.\/independentApi\.js\?rmv=1\.5\.18-audit1c2/);
