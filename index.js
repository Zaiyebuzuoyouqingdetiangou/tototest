import { initRabbitMirrorUI, destroyRabbitMirrorUI } from './src/ui.js?rmv=1.4.30.13';
import { rabbitMirrorGenerateInterceptor, clearRabbitMirrorPrompt } from './src/injector.js?rmv=1.4.30.13';
import { clearLastCombo } from './src/storage.js?rmv=1.4.30.13';
import { initVisualScanner, destroyVisualScanner } from './src/visualScanner.js?rmv=1.4.30.13';
import { initOutputSanitizer, destroyOutputSanitizer } from './src/outputSanitizer.js?rmv=1.4.30.13';
import { clearAllFeedbackCatState, destroyFeedbackCatPromptSync, initFeedbackCatPromptSync } from './src/feedbackCat.js?rmv=1.4.30.13';
import { getSettings } from './src/settings.js?rmv=1.4.30.13';
import { clearRabbitMirrorGenerationSnapshots } from './src/generationGuard.js?rmv=1.4.30.13';
import { initIndependentRabbitMirror, destroyIndependentRabbitMirror } from './src/independentApi.js?rmv=1.4.30.13';
import { initTouchTheaterBridge, destroyTouchTheaterBridge } from './src/touchTheater.js?rmv=1.4.30.13';

const RABBIT_MIRROR_RUNTIME_VERSION = '1.4.30.13';
