import { initRabbitMirrorUI, destroyRabbitMirrorUI } from './src/ui.js?rmv=1.4.30.9';
import { rabbitMirrorGenerateInterceptor, clearRabbitMirrorPrompt } from './src/injector.js?rmv=1.4.30.9';
import { clearLastCombo } from './src/storage.js?rmv=1.4.30.9';
import { initVisualScanner, destroyVisualScanner } from './src/visualScanner.js?rmv=1.4.30.9';
import { initOutputSanitizer, destroyOutputSanitizer } from './src/outputSanitizer.js?rmv=1.4.30.9';
import { clearAllFeedbackCatState, destroyFeedbackCatPromptSync, initFeedbackCatPromptSync } from './src/feedbackCat.js?rmv=1.4.30.9';
import { getSettings } from './src/settings.js?rmv=1.4.30.9';
import { clearRabbitMirrorGenerationSnapshots } from './src/generationGuard.js?rmv=1.4.30.9';
import { initIndependentRabbitMirror, destroyIndependentRabbitMirror } from './src/independentApi.js?rmv=1.4.30.9';
import { initTouchTheaterBridge, destroyTouchTheaterBridge } from './src/touchTheater.js?rmv=1.4.30.9';

const RABBIT_MIRROR_RUNTIME_VERSION = '1.4.30.9';
