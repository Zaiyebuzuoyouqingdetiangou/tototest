import { initRabbitMirrorUI, destroyRabbitMirrorUI } from './src/ui.js?rmv=1.2.48';
import { rabbitMirrorGenerateInterceptor, clearRabbitMirrorPrompt } from './src/injector.js?rmv=1.2.48';
import { clearLastCombo } from './src/storage.js?rmv=1.2.48';
import { initVisualScanner, destroyVisualScanner } from './src/visualScanner.js?rmv=1.2.48';
import { initOutputSanitizer, destroyOutputSanitizer } from './src/outputSanitizer.js?rmv=1.2.48';
import { clearAllFeedbackCatState, destroyFeedbackCatPromptSync, initFeedbackCatPromptSync } from './src/feedbackCat.js?rmv=1.2.48';
import { getSettings } from './src/settings.js?rmv=1.2.48';
import { clearRabbitMirrorGenerationSnapshots } from './src/generationGuard.js?rmv=1.2.48';
import { initIndependentRabbitMirror, destroyIndependentRabbitMirror } from './src/independentApi.js?rmv=1.2.48';

const RABBIT_MIRROR_RUNTIME_VERSION = '1.2.48';
