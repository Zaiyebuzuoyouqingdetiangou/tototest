import { initRabbitMirrorUI, destroyRabbitMirrorUI } from './src/ui.js?rmv=1.1.0b14h33t';
import { rabbitMirrorGenerateInterceptor, clearRabbitMirrorPrompt } from './src/injector.js?rmv=1.1.0b14h33t';
import { clearLastCombo } from './src/storage.js?rmv=1.1.0b14h33t';
import { initVisualScanner } from './src/visualScanner.js?rmv=1.1.0b14h33t';
import { initOutputSanitizer, destroyOutputSanitizer } from './src/outputSanitizer.js?rmv=1.1.0b14h33t';
import { clearAllFeedbackCatState, destroyFeedbackCatPromptSync, initFeedbackCatPromptSync } from './src/feedbackCat.js?rmv=1.1.0b14h33t';
import { getSettings } from './src/settings.js?rmv=1.1.0b14h33t';
import { clearRabbitMirrorGenerationSnapshots } from './src/generationGuard.js?rmv=1.1.0b14h33t';
import { initIndependentRabbitMirror, destroyIndependentRabbitMirror } from './src/independentApi.js?rmv=1.1.0b14h33t';

const RABBIT_MIRROR_RUNTIME_VERSION = '1.1.0-beta.14.33-test';
