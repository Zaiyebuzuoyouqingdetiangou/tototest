...
// equivalent to its preflight value.
{
    ...
    const callSandbox = {
        ...
        independentSelectedFormatDescriptors: metadata => (Array.isArray(metadata?.formatIds) ? metadata.formatIds : []).map((id, index) => ({ id: String(id), title: String(metadata?.formatLabels?.[index] || id), summary: '', tags: [] })),
